...
output "natgw_id"                  { value = length(module.nat-gateway) > 0 ? module.nat-gateway[0].natgw_id : null }
output "natgw_public_ip"           { value = length(module.nat-gateway) > 0 ? module.nat-gateway[0].natgw_public_ip : null }
