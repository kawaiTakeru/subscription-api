...
# ===========================================================
locals {
  name_bastion_host        = var.project_slug != "" ? "bastion-${var.project_slug}-${lower(var.vnet_type)}-${var.environment_id}-${var.region_code}-${var.sequence}" : null
  name_bastion_public_ip   = var.project_slug != "" ? "pip-${var.project_slug}-bastion-${var.environment_id}-${var.region_code}-${var.sequence}" : null
}
